...
const Cancelled = ({ dataCancel }) => {
  if (dataCancel.length === 0) {
    return (
      <div className="min-h-[20rem] flex flex-col items-center justify-center gap-3 sm:gap-4 bg-gray-50 rounded-lg sm:rounded-xl p-4 sm:p-8">
        <VscDiscard className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400" />
        <p className="text-sm sm:text-base text-gray-500 font-medium">No Cancelled Orders Yet</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-3 sm:p-6">
      <div className="flex items-center gap-2 mb-4 sm:mb-6">
        ...
        <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Cancelled Orders</h2>
      </div>
