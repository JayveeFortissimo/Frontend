...
export function LensDemo({image,name,description}) {
  const [hovering, setHovering] = useState(false);

  return (
    (<div>
      <div
        className="w-[19rem] h-[40rem] relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10">
        <Rays />
        <Beams />
  ...
  return (
    (<svg
      ...
      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#27272a" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#27272a" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#27272a" />
      </g>
      <defs>
        <filter
    ...
    (<svg
      ...
      <defs>
        ...
        <linearGradient
          ...
          <stop offset="0.214779" stopColor="#27272a" />
