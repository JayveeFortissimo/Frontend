...
const handleSubmitCategory = async(e) =>{
    e.preventDefault();
    try{
 const response = await fetch(`https://backend-production-024f.up.railway.app/addCategorys`,{
    method:'POST',
    headers:{
...
const handleSubmitColors = async(e) =>{
    e.preventDefault();
    try{
 const response = await fetch(`https://backend-production-024f.up.railway.app/addColors`,{
    method:'POST',
    headers:{
        'Content-Type':'application/json'
    },
...
const handleSubmitMaterials = async(e) =>{
    e.preventDefault();
    try{
 const response = await fetch(`https://backend-production-024f.up.railway.app/addMaterials`,{
    method:'POST',
    headers:{
        'Content-Type':'application/json'
    },
