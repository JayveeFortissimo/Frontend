    ...
    useEffect(()=>{
        ...
        async function data() {
           try{
            ...
            const response = await fetch(`https://backend-production-024f.up.railway.app/orders/${ID.id}`,{
              method:'GET',
              headers:{
      ...
      useEffect(()=>{
        ...
        async function Size() {
          try{
           ...
           const response = await fetch(`https://backend-production-024f.up.railway.app/Size/${SizeName.id}`,{
             method:'GET',
             headers:{
               'Content-Type':'application/json'
             }
      ...
      useEffect(() => {
        ...
        socket.current = io("https://backend-production-024f.up.railway.app"); 
...
useEffect(()=>{
  const allCancell = async() =>{
    ...
    try{
      ...
      const response = await fetch(`https://backend-production-024f.up.railway.app/allCanceled/${ID.id}`,{
        method:"GET",
        headers:{
          'Content-Type':'application/json'
        }
...
useEffect(()=>{
  const allNotifs = async() =>{
    ...
    try{
      ...
      const response = await fetch(`https://backend-production-024f.up.railway.app/notifications/${ID.id}`,{
        method:"GET",
        headers:{
          'Content-Type':'application/json'
        }
